...
final aiosLightTheme = ThemeData.light().copyWith(
  ...
  dialogTheme: DialogThemeData(
    backgroundColor: LightColors.surfaceModal,
    shape: RoundedRectangleBorder(
      borderRadius: BorderRadius.circular(AppRadius.md),
    ),
    titleTextStyle: const TextStyle(
...
ThemeData aiosThemeOf(ThemeMode mode) {
    return switch (mode) {
      ThemeMode.light => aiosLightTheme,
      ThemeMode.dark => aiosDarkTheme,
      ThemeMode.system => aiosDarkTheme,
    };
  }
